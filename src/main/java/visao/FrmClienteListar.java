...
public class FrmClienteListar extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmClienteListar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void preencherTabela() {
        ...
        List<Cliente> clientes = clientedao.consultarTudo();
        String[] nomeColunas = {"id", "nome", "endereco", "cidade", "uf", "cep", "escolaridade"};
        DefaultTableModel aModel = (DefaultTableModel) jTable1.getModel();
        aModel.setColumnIdentifiers(nomeColunas);
        Object[] objects = new Object[nomeColunas.length];
        for (int i = 0; i < clientes.size(); i++) {
            Cliente cliente = (Cliente) clientes.get(i);
            objects[0] = cliente.getClienteId();
            objects[1] = cliente.getNome();
            objects[2] = cliente.getEndereco();
            objects[3] = cliente.getCidade();
            objects[4] = cliente.getEstado();
            objects[5] = cliente.getCep();
            objects[6] = cliente.getEscolaridade();
